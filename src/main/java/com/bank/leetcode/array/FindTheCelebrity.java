...
// Note: There will be exactly one celebrity
...
public class FindTheCelebrity extends Relation {
        public int findCelebrity(int n) {
            ...
            //'find out' for()  who the viable 'candidate'
            for(int i = 1; i < n; i++) {
            ...
            for(int i = 0; i < n; i++) {
                //'if' the candidate 'knows' the current person
                // 'or' the current person does not know the candidate, return -1 (candidate is not a celebrity)
